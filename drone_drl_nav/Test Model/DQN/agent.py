...
class ReplayBuffer():
    def __init__(self, max_size=50000): # Tăng bộ nhớ lên 50k
...
class DroneNet(nn.Module):
    def __init__(self, n_actions=5, state_vector_dim=17):
        ...
        # Mạng FCN xử lý vận tốc, góc nghiêng
        ...
        # --- CHUYỂN VỀ DQN TIÊU CHUẨN ---
        # Chỉ dùng 1 luồng duy nhất để tính thẳng Q-values cho các hành động
