...
file_name = 'drone_flight_log_test_D3QN.csv' # hoặc 'drone_flight_log_fixed.csv'
...
ax1.set_title('Biểu đồ Điểm thưởng (Accumulated Reward) qua các hiệp của D3QN')
ax1.set_ylabel('Điểm')
...
ax2.set_title('Biểu đồ Tỷ lệ chiến thắng (Win Rate) của D3QN')
